...
$usercount=mysql_query("SELECT * FROM patients") or die ('the query failed.'); 
$count=mysql_num_rows($usercount);
echo'There are currently '.$count.' patients registered.';
?>
</div>

<a href="viewpatients.php">View Patient list</a>
