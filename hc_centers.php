...
<h2>HEALTH CENTERS | CLINICS</h2> 

<div class="box">
		<h3>Structure of Health Service Delivery</h3><br />
		<a href="levels.php"><input type="submit" name="" value="Click here"></a>
</div>

<div id="box">
		<h3>Establishment Details</h3><br />
		<a href="auditstaff.html"><input type="submit" name="" value="Click here"></a>
</div>
